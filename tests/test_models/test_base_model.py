...
class TestToDictMethod(unittest.TestCase):
    ...
    def test_dictionary_representation(self):
        ...
        self.assertEqual(model_dict['__class__'], model_instance.__class__.__name__)
        self.assertEqual(model_dict['created_at'], model_instance.created_at.isoformat())
        self.assertEqual(model_dict['updated_at'], model_instance.updated_at.isoformat())
